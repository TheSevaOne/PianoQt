...
void MainWindow::keyReleaseEvent(QKeyEvent* event){
    ...
    case 0x21: // !
        MainWindow::on_pushButton_CS1_released();
        break;
    case 0x32: // 2
        MainWindow::on_pushButton_D1_released();
        break;
    case 0x40: // @
        MainWindow::on_pushButton_DS1_released();
        break;
    case 0x33: // 3
        MainWindow::on_pushButton_E1_released();
        break;
    case 0x34: // 4
        MainWindow::on_pushButton_F1_released();
        break;
    case 0x24: // $
        MainWindow::on_pushButton_FS1_released();
        break;
    case 0x35: // 5
        MainWindow::on_pushButton_G1_released();
        break;
    case 0x25: // %
        MainWindow::on_pushButton_GS1_released();
        break;
    case 0x36: // 6
        MainWindow::on_pushButton_A1_released();
        break;
    case 0x5E: // ^
        MainWindow::on_pushButton_AS1_released();
        break;
    case 0x37: // 7
        MainWindow::on_pushButton_B1_released();;
        break;
    case 0x38: // 8
        MainWindow::on_pushButton_C2_released();
        break;
    case 0x2A: // *
        MainWindow::on_pushButton_CS2_released();
        break;
    case 0x39: // 9
        MainWindow::on_pushButton_D2_released();
        break;
    case 0x28: // (
        MainWindow::on_pushButton_DS2_released();
        break;
    case 0x30: // 0
        MainWindow::on_pushButton_E2_released();
        break;
    case 0x51: //q
        if (event->modifiers())
            MainWindow::on_pushButton_FS2_released();
        else
            MainWindow::on_pushButton_F2_released();
        break;
    case 0x57: //w
        if (event->modifiers())
            MainWindow::on_pushButton_GS2_released();
        else
            MainWindow::on_pushButton_G2_released();
        break;
     case 0x45: //e
        if (event->modifiers())
            MainWindow::on_pushButton_AS2_released();
        else
            MainWindow::on_pushButton_A2_released();
        break;
     case 0x52: //r
            MainWindow::on_pushButton_B2_released();
        break;
     case 0x54: //t
        if (event->modifiers())
            MainWindow::on_pushButton_CS3_released();
        else
            MainWindow::on_pushButton_C3_released();
        break;
    case 0x59: //y
        if (event->modifiers())
            MainWindow::on_pushButton_DS3_released();
        else
            MainWindow::on_pushButton_D3_released();
        break;
    case 0x55: //u
            MainWindow::on_pushButton_E3_released();
        break;
    case 0x49: //i
        if (event->modifiers())
            MainWindow::on_pushButton_FS3_released();
        else
            MainWindow::on_pushButton_F3_released();
        break;
    case 0x4f: //o
        if (event->modifiers())
            MainWindow::on_pushButton_GS3_released();
        else
            MainWindow::on_pushButton_G3_released();
        break;
    case 0x50: //p
        if (event->modifiers())
            MainWindow::on_pushButton_AS3_released();
        else
            MainWindow::on_pushButton_A3_released();
        break;
    case 0x41: //a
            MainWindow::on_pushButton_B3_released();
        break;
    case 0x53: //s
        if (event->modifiers())
            MainWindow::on_pushButton_CS4_released();
        else
            MainWindow::on_pushButton_C4_released();
        break;
    case 0x44: //d
        if (event->modifiers())
            MainWindow::on_pushButton_DS4_released();
        else
            MainWindow::on_pushButton_D4_released();
        break;
    case 0x46: //f
            MainWindow::on_pushButton_E4_released();
        break;
    case 0x47: //g
        if (event->modifiers())
            MainWindow::on_pushButton_FS4_released();
        else
            MainWindow::on_pushButton_F4_released();
        break;
    case 0x48: //h
        if (event->modifiers())
            MainWindow::on_pushButton_GS4_released();
        else
            MainWindow::on_pushButton_G4_released();
        break;
    case 0x4a: //j
        if (event->modifiers())
            MainWindow::on_pushButton_AS4_released();
        else
            MainWindow::on_pushButton_A4_released();
        break;
    case 0x4b: //k
            MainWindow::on_pushButton_B4_released();
        break;
    case 0x4c: //l
        if (event->modifiers())
            MainWindow::on_pushButton_CS5_released();
        else
            MainWindow::on_pushButton_C5_released();
        break;
    case 0x5a: //z
        if (event->modifiers())
            MainWindow::on_pushButton_DS5_released();
        else
            MainWindow::on_pushButton_D5_released();
        break;
    case 0x58: //x
            MainWindow::on_pushButton_E5_released();
        break;
    case 0x43: //c
        if (event->modifiers())
            MainWindow::on_pushButton_FS5_released();
        else
            MainWindow::on_pushButton_F5_released();
        break;
    case 0x56: //v
        if (event->modifiers())
            MainWindow::on_pushButton_GS5_released();
        else
            MainWindow::on_pushButton_G5_released();
        break;
    case 0x42: //b
        if (event->modifiers())
            MainWindow::on_pushButton_AS5_released();
        else
            MainWindow::on_pushButton_A5_released();
        break;
    case 0x4e: //n
            MainWindow::on_pushButton_B5_released();
        break;
    case 0x4d: //m
            MainWindow::on_pushButton_C6_released();
        break;
